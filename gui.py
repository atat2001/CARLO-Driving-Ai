...
autonomous_list.append(PhaseAgent(c3,["6","1","8", "16", "15"]))
for road in roads:
    goal  = roads[road]
    start = goal[0]
    end   = goal[1]
...
autonomous_list.append(PhaseAgent(c2,["1","8","11","12"]))

autonomous_list.append(PhaseAgent(c3,["28","19","11", "12"]))

autonomous_list.append(PhaseAgent(c4,["11","4","1"]))
